...
class DebugDisplay extends Component<IProps, IState> {
  ...
  debugInto() {
    ...
    const index = this.state.indx < txTrace.length - 1 ? this.state.indx + 1 : txTrace.length - 1;
    if (txTrace.length > 0) {
      this.setState({
        indx: index,
    ...
    return (
      <div className="container">
        <div>
          ...
          <p>
            <button className="text-subtle custom_button_css" onClick={this.stopDebug}>
              Stop
            </button>
          </p>
        </div>
        {indx >= 0 && (
          <div>
            <div>
              ...
              <div>
                <p>
                  <button className="custom_button_css" style={{ marginRight: "20px" }} onClick={this.debugBack}>
                    Step Back
                  </button>
                  <button className="custom_button_css" onClick={this.debugInto}>
                    Step Into
                  </button>
                </p>
              </div>
